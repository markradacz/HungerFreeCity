...
//            if let json = NSJSONSerialization.JSONObjectWithData(data!, options:nil) as? NSDictionary {
...
//            if let json = NSJSONSerialization.JSONObjectWithData(data!, options:nil) as? [String:AnyObject] {
