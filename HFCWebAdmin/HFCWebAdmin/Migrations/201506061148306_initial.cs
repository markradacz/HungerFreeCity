namespace HFCWebAdmin.Migrations
{
	...
	public partial class initial : DbMigration
	{
		public override void Up()
		{
			...
			CreateTable(
				"dbo.DistributorLocations",
				c => new
				{
					ID = c.Int( nullable: false, identity: true ),
					DistributorID = c.Int( nullable: false, identity: false ),
					Address1 = c.String( nullable: false, maxLength: 128 ),
					Address2 = c.String( nullable: true, maxLength: 128 ),
					City = c.String( nullable: true, maxLength: 128 ),
					State = c.String( nullable: true, maxLength: 128 ),
					ZipCode = c.String( nullable: false, maxLength: 128 ),
					PhoneNumber = c.String( nullable: false, maxLength: 128 ),
					Enabled = c.Boolean( nullable: false ),
					CreatedAt = c.DateTime( nullable: false ),
